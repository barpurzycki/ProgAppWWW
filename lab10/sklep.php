        ...
        <div class="DodajKat">
            <form method="post" name="NewCategoryForm" enctype="multipart/form-data" action="' . $_SERVER['REQUEST_URI'] . '">
                <table class="DodajKat">
                    ...
                    <tr><td>&nbsp;</td><td><input type="submit" name="x1_submit" class="DodajKat" value="Dodaj" /></td></tr>
                </table>
            </form>
        </div>
    </div>
        ...
        <div class="UsuwanieCat">
            <form method="post" name="DeleteCategoryForm" enctype="multipart/form-data" action="' . $_SERVER['REQUEST_URI'] . '">
                <table class="UsuwanieCat">
                    <tr><td class="rem_4t">ID kategorii: </td><td><input type="text" name="id_usuwanie_cat" class="UsuwanieCat" /></td></tr>
                    <tr><td>&nbsp;</td><td><input type="submit" name="x2_submit" class="UsuwanieCat" value="Usuń" /></td></tr>
                </table>
            </form>
        </div>
    </div>
        ...
        <div class="EdytujCat">
            <form method="post" name="EditCatForm" enctype="multipart/form-data" action="' . $_SERVER['REQUEST_URI'] . '">
                <table class="EdytujCat">
                    <tr><td class="edit_4t">ID kategorii: </td><td><input type="text" name="id_edycja_cat" class="EdytujCat" /></td></tr>
                    <tr><td class="edit_4t">Nazwa kategorii : </td><td><input type="text" name="cat_name_edycja" class="EdytujCat" /></td></tr>
                    <tr><td class="edit_4t">ID Matki: </td><td><input type="text" name="mother_id_edycja" class="EdytujCat" /></td></tr>
                    <tr><td>&nbsp;</td><td><input type="submit" name="x3_submit" class="EdytujCat" value="Edytuj" /></td></tr>
                </table>
            </form>
        </div>
    </div>
