...
#Funkcja wypisująca listę produktów z bazy danych
function ListaProduktow()
{
    global $link;

    $query = "SELECT p.*, k.nazwa AS nazwa_kategorii FROM produkty AS p LEFT JOIN kategorie AS k ON p.kategoria = k.id";
    ...
    if ($result->num_rows > 0) 
    {
        while ($row = $result->fetch_assoc()) 
        {
            ...
            echo "Kategoria: " . $row["nazwa_kategorii"] . "<br>";
...
#Funkcja wyświetlająca formularz do dodawania produktów do bazy danych
...
#Funkcja umożliwiająca dodawanie produktów do bazy danych
...
#Funkcja wyświetlająca formularz do usuwania produktów z bazy danych
...
#Funkcja umożliwiająca usuwanie produktów z bazy danych
...
#Funkcja wyświetlająca formularz umożliwiający edytowanie produktów w bazie danych
...
#Funkcja umożliwiająca edytowanie produktów w bazie danych
